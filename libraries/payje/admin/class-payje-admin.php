...
class PayJe_Admin {
    ...
    private function dashboard_page() {
        ...
        $payje_wc_plugin = $this->get_plugin_url( 'woocommerce/woocommerce.php', 'payje-woocommerce/payje-wc.php', 'wc', __( 'WooCommerce', 'payje' ) );
        $payje_gf_plugin = $this->get_plugin_url( 'gravityforms/gravityforms.php', 'payje-gravityforms/payje-gf.php', 'gf', __( 'Gravity Forms', 'payje' ) );
